...
import { IERC6551Register } from "./interfaces/IERC6551Register.sol";
...
contract CDH is ICDH, ERC721, ERC721Enumerable, ERC721Burnable {
	...
	address public erc6551Register;
	...
	constructor(
		...
		address _erc6551Register,
		address _erc6551Account
	) ERC721(name, symbol) {
		erc6551Register = _erc6551Register;
	...
	function safeMint(address to, string memory uri) public notOwnNFT(to) {
		...
		IERC6551Register(erc6551Register).register(tokenId);
		// save DACS or ...
