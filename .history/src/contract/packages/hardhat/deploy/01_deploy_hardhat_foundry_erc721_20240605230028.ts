...
const deployCDHContract: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  console.log("🚀 Deploy ERC6551Account Contract:", await erc6551AccountContract.getAddress());
  ...
  console.log("🚀 Deploy ERC6551Registry Contract:", await erc6551RegistryContract.getAddress());
