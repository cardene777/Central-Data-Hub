                ...
                <div className="w-full text-left max-w-sm rounded overflow-hidden shadow-lg flex flex-col items-start">
                  <div className="px-6 py-4">
                    <p className="font-bold text-xl mb-2">
                      field number <span className="font-normal block">{field.number.toString()}</span>
                    </p>
                    <p className="font-bold text-xl mb-2">
                      field name <span className="font-normal block">{field.name}</span>
                    </p>
                    <p className="font-bold text-xl mb-2">
                      field owner <span className="font-normal block">{field.owner}</span>
                    </p>
                  </div>
                </div>
              </div>
