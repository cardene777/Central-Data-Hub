              ...
              <div key={index} className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/4 px-2 mb-4">
                <div className="w-full text-left max-w-sm rounded overflow-hidden shadow-lg flex flex-col items-start">
                  <div className="px-6 py-4">
                    <p className="font-bold text-xl mb-2">field number <span className="font-normal">{field.number.toString()}</span></p>
                    <p className="font-bold text-xl mb-2">field name <span className="font-normal">{field.name}</span></p>
                    <p className="font-bold text-xl mb-2">field owner <span className="font-normal">{field.owner}</span></p>
                  </div>
                </div>
              </div>
            ))}
